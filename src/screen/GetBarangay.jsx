        ...
        {elections.length > 0 && (
          <div className="flex flex-col gap-4">
            ...
            <div className="bg-white rounded-2xl p-4 shadow border border-gray-200">
              ...
              <div className="overflow-x-auto max-h-[520px] overflow-y-auto rounded-md border border-gray-200">
                <table className="min-w-full table-auto">
                  <thead className="bg-blue-100 sticky top-0 z-10">
                    <tr className="border-b border-gray-300 text-gray-800">
                      ...
                      <th className="px-6 py-4 text-left">Live Results</th>
                    </tr>
                  </thead>
                  <tbody>
                      ...
                      election.candidates?.length > 0 ? (
                        ...
                        >
                          ...
                          <td className="px-6 py-2">
                            <button
                              onClick={() => connectToSocket(election._id)}
                              className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700"
                            >
                              View Results
                            </button>
