...
function Sidebar(props) {
  ...
  return (
    <div className="flex flex-col 2xl:basis-[20%] basis-[30%] rounded-tr-3xl rounded-br-3xl min-h-screen px-4 py-8 bg-blue-100 gap-4 justify-between">
      <div className="flex flex-col gap-2">
        <h1 className="text-center text-3xl font-bold my-8">LOGO</h1>
        <button
          className="flex flex-row items-center py-4 px-8 bg-blue-800 shadow-md rounded-3xl text-blue-50 hover:bg-blue-700 cursor-pointer transition-all delay-0 duration-300 gap-4"
